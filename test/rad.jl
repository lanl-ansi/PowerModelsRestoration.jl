...
@testset "RAD" begin
    ...
    @testset "test AC RAD" begin
        @testset "5-bus case" begin
            # result = PowerModelsRestoration.run_RAD(data, PowerModels.ACPPowerModel, juniper_solver)
    ...
    @testset "test SOCWR RAD" begin
        @testset "5-bus case" begin
            # result = PowerModelsRestoration.run_RAD(data, PowerModels.SOCWRPowerModel, juniper_solver)
    ...
    @testset "test dc RAD" begin
        ...
        @testset "multi-item restore" begin
            ...
            # result = run_RAD(data, PowerModels.DCPPowerModel, cbc_solver)
            # @test result["termination_status"] == PowerModels.OPTIMAL

            # ## TODO What tests should compare ROP and RAD restoration?
        end

        @testset "totally damaged scenario" begin
            #  # totally damaged 3_bus system
            #  data = PowerModels.parse_file("../test/data/case3_restoration_RAD.m")
