...
@testset "Iterative" begin
    ...
    @testset "test AC Iterative" begin
        @testset "5-bus case" begin
            result = PowerModelsRestoration.run_iterative_restoration(data, PowerModels.ACPPowerModel, juniper_solver)
    ...
    @testset "test SOCWR Iterative" begin
        @testset "5-bus case" begin
            result = PowerModelsRestoration.run_iterative_restoration(data, PowerModels.SOCWRPowerModel, juniper_solver)
    ...
    @testset "test dc Iterative" begin
        ...
        @testset "5-bus case" begin
            result = PowerModelsRestoration.run_iterative_restoration(data, PowerModels.DCPPowerModel, cbc_solver)
        ...
        @testset "multi-item restore" begin
            ...
            result = run_iterative_restoration(data, PowerModels.DCPPowerModel, cbc_solver)
            @test result["termination_status"] == PowerModels.OPTIMAL

            ## TODO What tests should compare ROP and iterative restoration?
        end
